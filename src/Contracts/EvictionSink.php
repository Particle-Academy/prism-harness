 ...
 * longer see what it did, and — measured, on a real audit workload — it either
 * repeats the work or refuses to finish rather than report a total it cannot
 * stand behind. One consumer's agent asserted a count from evidence that had
 * already been cleared, was right by coincidence, and caught itself. There is no
 * error and no log line when that goes the other way.
 *
